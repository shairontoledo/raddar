  ...
  def create
    ...
    if f.save
      ...
      if @followable.class == User
        notification = @followable.notifications.new content: I18n.t('notification.follower.html', author: current_user.name), item_path: current_user, notifiable: current_user
        notification.save
